...
// ClusterClusterProfile ClusterProfile provides configuration options that apply to the whole cluster.
type ClusterClusterProfile struct {
	ApiVersion *string `json:"api-version,omitempty"`
	Kind *string `json:"kind,omitempty"`
	Meta *ApiObjectMeta `json:"meta,omitempty"`
	Spec *ClusterClusterProfileSpec `json:"spec,omitempty"`
	// ClusterProfileStatus contains the current state of the ClusterProfile.
...
func (o *ClusterClusterProfile) GetSpec() ClusterClusterProfileSpec {
	if o == nil || o.Spec == nil {
		var ret ClusterClusterProfileSpec
		return ret
	}
	return *o.Spec
}
...
// SetSpec gets a reference to the given ClusterClusterProfileSpec and assigns it to the Spec field.
...
func (o ClusterClusterProfile) MarshalJSON() ([]byte, error) {
...
type NullableClusterClusterProfile struct {
	value *ClusterClusterProfile
	isSet bool
}

func (v NullableClusterClusterProfile) Get() *ClusterClusterProfile {
	return v.value
}

func (v *NullableClusterClusterProfile) Set(val *ClusterClusterProfile) {
	v.value = val
	v.isSet = true
}

func (v NullableClusterClusterProfile) IsSet() bool {
	return v.isSet
}

func (v *NullableClusterClusterProfile) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClusterClusterProfile(val *ClusterClusterProfile) *NullableClusterClusterProfile {
	return &NullableClusterClusterProfile{value: val, isSet: true}
}

func (v NullableClusterClusterProfile) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClusterClusterProfile) UnmarshalJSON(src []byte) error {
	v.isSet = true
