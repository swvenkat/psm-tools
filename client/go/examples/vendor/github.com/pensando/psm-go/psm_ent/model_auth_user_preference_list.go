...
// AuthUserPreferenceList UserPreferenceList is a container object for list of UserPreference objects.
type AuthUserPreferenceList struct {
	ApiVersion *string `json:"api-version,omitempty"`
	// List of UserPreference objects.
	Items *[]AuthUserPreference `json:"items,omitempty"`
...
// SetItems gets a reference to the given []AuthUserPreference and assigns it to the Items field.
...
func (o AuthUserPreferenceList) MarshalJSON() ([]byte, error) {
...
type NullableAuthUserPreferenceList struct {
	value *AuthUserPreferenceList
	isSet bool
}

func (v NullableAuthUserPreferenceList) Get() *AuthUserPreferenceList {
	return v.value
}

func (v *NullableAuthUserPreferenceList) Set(val *AuthUserPreferenceList) {
	v.value = val
	v.isSet = true
}

func (v NullableAuthUserPreferenceList) IsSet() bool {
	return v.isSet
}

func (v *NullableAuthUserPreferenceList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAuthUserPreferenceList(val *AuthUserPreferenceList) *NullableAuthUserPreferenceList {
	return &NullableAuthUserPreferenceList{value: val, isSet: true}
}

func (v NullableAuthUserPreferenceList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAuthUserPreferenceList) UnmarshalJSON(src []byte) error {
	v.isSet = true
