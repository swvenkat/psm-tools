...
// AuthRole Role is a collection of permissions.
type AuthRole struct {
	ApiVersion *string `json:"api-version,omitempty"`
	Kind *string `json:"kind,omitempty"`
	Meta *ApiObjectMeta `json:"meta,omitempty"`
	Spec *AuthRoleSpec `json:"spec,omitempty"`
...
// SetSpec gets a reference to the given AuthRoleSpec and assigns it to the Spec field.
...
func (o AuthRole) MarshalJSON() ([]byte, error) {
...
type NullableAuthRole struct {
	value *AuthRole
	isSet bool
}

func (v NullableAuthRole) Get() *AuthRole {
	return v.value
}

func (v *NullableAuthRole) Set(val *AuthRole) {
	v.value = val
	v.isSet = true
}

func (v NullableAuthRole) IsSet() bool {
	return v.isSet
}

func (v *NullableAuthRole) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAuthRole(val *AuthRole) *NullableAuthRole {
	return &NullableAuthRole{value: val, isSet: true}
}

func (v NullableAuthRole) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAuthRole) UnmarshalJSON(src []byte) error {
	v.isSet = true
