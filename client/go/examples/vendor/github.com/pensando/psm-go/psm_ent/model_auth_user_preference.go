...
// AuthUserPreference UserPreference holds all user customization info.
type AuthUserPreference struct {
	ApiVersion *string `json:"api-version,omitempty"`
	Kind *string `json:"kind,omitempty"`
	Meta *ApiObjectMeta `json:"meta,omitempty"`
	Spec *AuthUserPreferenceSpec `json:"spec,omitempty"`
...
func (o *AuthUserPreference) GetSpec() AuthUserPreferenceSpec {
	if o == nil || o.Spec == nil {
		var ret AuthUserPreferenceSpec
		return ret
	}
	return *o.Spec
}
...
// SetSpec gets a reference to the given AuthUserPreferenceSpec and assigns it to the Spec field.
...
func (o AuthUserPreference) MarshalJSON() ([]byte, error) {
...
type NullableAuthUserPreference struct {
	value *AuthUserPreference
	isSet bool
}

func (v NullableAuthUserPreference) Get() *AuthUserPreference {
	return v.value
}

func (v *NullableAuthUserPreference) Set(val *AuthUserPreference) {
	v.value = val
	v.isSet = true
}

func (v NullableAuthUserPreference) IsSet() bool {
	return v.isSet
}

func (v *NullableAuthUserPreference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAuthUserPreference(val *AuthUserPreference) *NullableAuthUserPreference {
	return &NullableAuthUserPreference{value: val, isSet: true}
}

func (v NullableAuthUserPreference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAuthUserPreference) UnmarshalJSON(src []byte) error {
	v.isSet = true
