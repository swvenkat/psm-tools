...
// NetworkVirtualRouterPeeringGroup struct for NetworkVirtualRouterPeeringGroup
type NetworkVirtualRouterPeeringGroup struct {
	ApiVersion *string `json:"api-version,omitempty"`
	Kind *string `json:"kind,omitempty"`
	Meta *ApiObjectMeta `json:"meta,omitempty"`
	Spec *NetworkVirtualRouterPeeringGroupSpec `json:"spec,omitempty"`
	Status *NetworkVirtualRouterPeeringGroupStatus `json:"status,omitempty"`
}
...
func NewNetworkVirtualRouterPeeringGroup() *NetworkVirtualRouterPeeringGroup {
	this := NetworkVirtualRouterPeeringGroup{}
	return &this
}
...
func (o *NetworkVirtualRouterPeeringGroup) GetSpec() NetworkVirtualRouterPeeringGroupSpec {
	if o == nil || o.Spec == nil {
		var ret NetworkVirtualRouterPeeringGroupSpec
		return ret
	}
	return *o.Spec
}
...
// SetSpec gets a reference to the given NetworkVirtualRouterPeeringGroupSpec and assigns it to the Spec field.
...
func (o *NetworkVirtualRouterPeeringGroup) GetStatus() NetworkVirtualRouterPeeringGroupStatus {
	if o == nil || o.Status == nil {
		var ret NetworkVirtualRouterPeeringGroupStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given NetworkVirtualRouterPeeringGroupStatus and assigns it to the Status field.
func (o *NetworkVirtualRouterPeeringGroup) SetStatus(v NetworkVirtualRouterPeeringGroupStatus) {
	o.Status = &v
}

func (o NetworkVirtualRouterPeeringGroup) MarshalJSON() ([]byte, error) {
...
type NullableNetworkVirtualRouterPeeringGroup struct {
	value *NetworkVirtualRouterPeeringGroup
	isSet bool
}

func (v NullableNetworkVirtualRouterPeeringGroup) Get() *NetworkVirtualRouterPeeringGroup {
	return v.value
}

func (v *NullableNetworkVirtualRouterPeeringGroup) Set(val *NetworkVirtualRouterPeeringGroup) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkVirtualRouterPeeringGroup) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkVirtualRouterPeeringGroup) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkVirtualRouterPeeringGroup(val *NetworkVirtualRouterPeeringGroup) *NullableNetworkVirtualRouterPeeringGroup {
	return &NullableNetworkVirtualRouterPeeringGroup{value: val, isSet: true}
}

func (v NullableNetworkVirtualRouterPeeringGroup) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkVirtualRouterPeeringGroup) UnmarshalJSON(src []byte) error {
	v.isSet = true
