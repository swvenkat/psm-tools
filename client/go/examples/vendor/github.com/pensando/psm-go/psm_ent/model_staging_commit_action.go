...
// StagingCommitAction CommitAction commits the changes in the staging buffer. All staged entries are verified and if verification is successful they are commited.
type StagingCommitAction struct {
	ApiVersion *string `json:"api-version,omitempty"`
	Kind *string `json:"kind,omitempty"`
	Meta *ApiObjectMeta `json:"meta,omitempty"`
	Spec *map[string]interface{} `json:"spec,omitempty"`
	Status *StagingCommitActionStatus `json:"status,omitempty"`
}
...
func (o *StagingCommitAction) GetStatus() StagingCommitActionStatus {
	if o == nil || o.Status == nil {
		var ret StagingCommitActionStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given StagingCommitActionStatus and assigns it to the Status field.
func (o *StagingCommitAction) SetStatus(v StagingCommitActionStatus) {
	o.Status = &v
}

func (o StagingCommitAction) MarshalJSON() ([]byte, error) {
...
type NullableStagingCommitAction struct {
	value *StagingCommitAction
	isSet bool
}

func (v NullableStagingCommitAction) Get() *StagingCommitAction {
	return v.value
}

func (v *NullableStagingCommitAction) Set(val *StagingCommitAction) {
	v.value = val
	v.isSet = true
}

func (v NullableStagingCommitAction) IsSet() bool {
	return v.isSet
}

func (v *NullableStagingCommitAction) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStagingCommitAction(val *StagingCommitAction) *NullableStagingCommitAction {
	return &NullableStagingCommitAction{value: val, isSet: true}
}

func (v NullableStagingCommitAction) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStagingCommitAction) UnmarshalJSON(src []byte) error {
	v.isSet = true
