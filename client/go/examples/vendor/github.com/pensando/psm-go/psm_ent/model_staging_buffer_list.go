...
// StagingBufferList BufferList is a container object for list of Buffer objects.
type StagingBufferList struct {
	ApiVersion *string `json:"api-version,omitempty"`
	// List of Buffer objects.
	Items *[]StagingBuffer `json:"items,omitempty"`
...
// SetItems gets a reference to the given []StagingBuffer and assigns it to the Items field.
...
func (o StagingBufferList) MarshalJSON() ([]byte, error) {
...
type NullableStagingBufferList struct {
	value *StagingBufferList
	isSet bool
}

func (v NullableStagingBufferList) Get() *StagingBufferList {
	return v.value
}

func (v *NullableStagingBufferList) Set(val *StagingBufferList) {
	v.value = val
	v.isSet = true
}

func (v NullableStagingBufferList) IsSet() bool {
	return v.isSet
}

func (v *NullableStagingBufferList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStagingBufferList(val *StagingBufferList) *NullableStagingBufferList {
	return &NullableStagingBufferList{value: val, isSet: true}
}

func (v NullableStagingBufferList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStagingBufferList) UnmarshalJSON(src []byte) error {
	v.isSet = true
