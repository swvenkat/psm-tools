...
// NetworkService Service represents a group of identical endpoints, such as servers in an app tier.
...
// SetSpec gets a reference to the given NetworkServiceSpec and assigns it to the Spec field.
...
// SetStatus gets a reference to the given NetworkServiceStatus and assigns it to the Status field.
