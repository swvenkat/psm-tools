...
// RoutingRoute struct for RoutingRoute
type RoutingRoute struct {
	ApiVersion *string `json:"api-version,omitempty"`
	Kind *string `json:"kind,omitempty"`
	Meta *ApiObjectMeta `json:"meta,omitempty"`
	Status *RoutingRouteStatus `json:"status,omitempty"`
}
...
// SetStatus gets a reference to the given RoutingRouteStatus and assigns it to the Status field.
func (o *RoutingRoute) SetStatus(v RoutingRouteStatus) {
	o.Status = &v
}

func (o RoutingRoute) MarshalJSON() ([]byte, error) {
...
type NullableRoutingRoute struct {
	value *RoutingRoute
	isSet bool
}

func (v NullableRoutingRoute) Get() *RoutingRoute {
	return v.value
}

func (v *NullableRoutingRoute) Set(val *RoutingRoute) {
	v.value = val
	v.isSet = true
}

func (v NullableRoutingRoute) IsSet() bool {
	return v.isSet
}

func (v *NullableRoutingRoute) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRoutingRoute(val *RoutingRoute) *NullableRoutingRoute {
	return &NullableRoutingRoute{value: val, isSet: true}
}

func (v NullableRoutingRoute) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRoutingRoute) UnmarshalJSON(src []byte) error {
	v.isSet = true
