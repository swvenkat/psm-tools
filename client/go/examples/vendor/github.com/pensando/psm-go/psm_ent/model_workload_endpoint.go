...
// WorkloadEndpoint Endpoint represents a network endpoint.
...
// SetSpec gets a reference to the given WorkloadEndpointSpec and assigns it to the Spec field.
...
func (o *WorkloadEndpoint) GetStatus() WorkloadEndpointStatus {
	if o == nil || o.Status == nil {
		var ret WorkloadEndpointStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given WorkloadEndpointStatus and assigns it to the Status field.
func (o *WorkloadEndpoint) SetStatus(v WorkloadEndpointStatus) {
	o.Status = &v
}

func (o WorkloadEndpoint) MarshalJSON() ([]byte, error) {
...
type NullableWorkloadEndpoint struct {
	value *WorkloadEndpoint
	isSet bool
}

func (v NullableWorkloadEndpoint) Get() *WorkloadEndpoint {
	return v.value
}

func (v *NullableWorkloadEndpoint) Set(val *WorkloadEndpoint) {
	v.value = val
	v.isSet = true
}

func (v NullableWorkloadEndpoint) IsSet() bool {
	return v.isSet
}

func (v *NullableWorkloadEndpoint) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWorkloadEndpoint(val *WorkloadEndpoint) *NullableWorkloadEndpoint {
	return &NullableWorkloadEndpoint{value: val, isSet: true}
}

func (v NullableWorkloadEndpoint) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWorkloadEndpoint) UnmarshalJSON(src []byte) error {
	v.isSet = true
