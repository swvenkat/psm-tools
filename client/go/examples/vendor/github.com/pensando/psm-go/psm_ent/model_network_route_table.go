...
// NetworkRouteTable struct for NetworkRouteTable
type NetworkRouteTable struct {
	ApiVersion *string `json:"api-version,omitempty"`
	Kind *string `json:"kind,omitempty"`
	Meta *ApiObjectMeta `json:"meta,omitempty"`
	Spec *map[string]interface{} `json:"spec,omitempty"`
	Status *NetworkRouteTableStatus `json:"status,omitempty"`
}
...
func (o *NetworkRouteTable) GetStatus() NetworkRouteTableStatus {
	if o == nil || o.Status == nil {
		var ret NetworkRouteTableStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given NetworkRouteTableStatus and assigns it to the Status field.
func (o *NetworkRouteTable) SetStatus(v NetworkRouteTableStatus) {
	o.Status = &v
}

func (o NetworkRouteTable) MarshalJSON() ([]byte, error) {
...
type NullableNetworkRouteTable struct {
	value *NetworkRouteTable
	isSet bool
}

func (v NullableNetworkRouteTable) Get() *NetworkRouteTable {
	return v.value
}

func (v *NullableNetworkRouteTable) Set(val *NetworkRouteTable) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkRouteTable) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkRouteTable) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkRouteTable(val *NetworkRouteTable) *NullableNetworkRouteTable {
	return &NullableNetworkRouteTable{value: val, isSet: true}
}

func (v NullableNetworkRouteTable) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkRouteTable) UnmarshalJSON(src []byte) error {
	v.isSet = true
