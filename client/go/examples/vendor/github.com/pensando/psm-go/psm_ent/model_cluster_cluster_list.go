...
// ClusterClusterList ClusterList is a container object for list of Cluster objects.
type ClusterClusterList struct {
	ApiVersion *string `json:"api-version,omitempty"`
	// List of Cluster objects.
	Items *[]ClusterCluster `json:"items,omitempty"`
...
// SetItems gets a reference to the given []ClusterCluster and assigns it to the Items field.
...
func (o ClusterClusterList) MarshalJSON() ([]byte, error) {
...
type NullableClusterClusterList struct {
	value *ClusterClusterList
	isSet bool
}

func (v NullableClusterClusterList) Get() *ClusterClusterList {
	return v.value
}

func (v *NullableClusterClusterList) Set(val *ClusterClusterList) {
	v.value = val
	v.isSet = true
}

func (v NullableClusterClusterList) IsSet() bool {
	return v.isSet
}

func (v *NullableClusterClusterList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClusterClusterList(val *ClusterClusterList) *NullableClusterClusterList {
	return &NullableClusterClusterList{value: val, isSet: true}
}

func (v NullableClusterClusterList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClusterClusterList) UnmarshalJSON(src []byte) error {
	v.isSet = true
