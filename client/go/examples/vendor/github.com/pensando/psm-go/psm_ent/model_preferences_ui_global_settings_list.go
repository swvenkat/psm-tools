...
// PreferencesUIGlobalSettingsList UIGlobalSettingsList is a container object for list of UIGlobalSettings objects.
type PreferencesUIGlobalSettingsList struct {
	ApiVersion *string `json:"api-version,omitempty"`
	// List of UIGlobalSettings objects.
	Items *[]PreferencesUIGlobalSettings `json:"items,omitempty"`
...
func NewPreferencesUIGlobalSettingsList() *PreferencesUIGlobalSettingsList {
	this := PreferencesUIGlobalSettingsList{}
	return &this
}
...
// SetItems gets a reference to the given []PreferencesUIGlobalSettings and assigns it to the Items field.
...
func (o PreferencesUIGlobalSettingsList) MarshalJSON() ([]byte, error) {
...
type NullablePreferencesUIGlobalSettingsList struct {
	value *PreferencesUIGlobalSettingsList
	isSet bool
}

func (v NullablePreferencesUIGlobalSettingsList) Get() *PreferencesUIGlobalSettingsList {
	return v.value
}

func (v *NullablePreferencesUIGlobalSettingsList) Set(val *PreferencesUIGlobalSettingsList) {
	v.value = val
	v.isSet = true
}

func (v NullablePreferencesUIGlobalSettingsList) IsSet() bool {
	return v.isSet
}

func (v *NullablePreferencesUIGlobalSettingsList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePreferencesUIGlobalSettingsList(val *PreferencesUIGlobalSettingsList) *NullablePreferencesUIGlobalSettingsList {
	return &NullablePreferencesUIGlobalSettingsList{value: val, isSet: true}
}

func (v NullablePreferencesUIGlobalSettingsList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePreferencesUIGlobalSettingsList) UnmarshalJSON(src []byte) error {
	v.isSet = true
