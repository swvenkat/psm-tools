...
// MonitoringEventPolicyList EventPolicyList is a container object for list of EventPolicy objects.
type MonitoringEventPolicyList struct {
	ApiVersion *string `json:"api-version,omitempty"`
	// List of EventPolicy objects.
	Items *[]MonitoringEventPolicy `json:"items,omitempty"`
...
func NewMonitoringEventPolicyList() *MonitoringEventPolicyList {
	this := MonitoringEventPolicyList{}
	return &this
}
...
// SetItems gets a reference to the given []MonitoringEventPolicy and assigns it to the Items field.
...
func (o MonitoringEventPolicyList) MarshalJSON() ([]byte, error) {
...
type NullableMonitoringEventPolicyList struct {
	value *MonitoringEventPolicyList
	isSet bool
}

func (v NullableMonitoringEventPolicyList) Get() *MonitoringEventPolicyList {
	return v.value
}

func (v *NullableMonitoringEventPolicyList) Set(val *MonitoringEventPolicyList) {
	v.value = val
	v.isSet = true
}

func (v NullableMonitoringEventPolicyList) IsSet() bool {
	return v.isSet
}

func (v *NullableMonitoringEventPolicyList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMonitoringEventPolicyList(val *MonitoringEventPolicyList) *NullableMonitoringEventPolicyList {
	return &NullableMonitoringEventPolicyList{value: val, isSet: true}
}

func (v NullableMonitoringEventPolicyList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMonitoringEventPolicyList) UnmarshalJSON(src []byte) error {
	v.isSet = true
