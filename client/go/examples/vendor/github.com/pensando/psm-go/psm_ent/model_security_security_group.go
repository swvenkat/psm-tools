...
// SecuritySecurityGroup SecurityGroup represents a security zone or domain.
type SecuritySecurityGroup struct {
	ApiVersion *string `json:"api-version,omitempty"`
	Kind *string `json:"kind,omitempty"`
	Meta *ApiObjectMeta `json:"meta,omitempty"`
	Spec *SecuritySecurityGroupSpec `json:"spec,omitempty"`
	Status *SecuritySecurityGroupStatus `json:"status,omitempty"`
}
...
func (o *SecuritySecurityGroup) GetSpec() SecuritySecurityGroupSpec {
	if o == nil || o.Spec == nil {
		var ret SecuritySecurityGroupSpec
		return ret
	}
	return *o.Spec
}
...
// SetSpec gets a reference to the given SecuritySecurityGroupSpec and assigns it to the Spec field.
...
func (o *SecuritySecurityGroup) GetStatus() SecuritySecurityGroupStatus {
	if o == nil || o.Status == nil {
		var ret SecuritySecurityGroupStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given SecuritySecurityGroupStatus and assigns it to the Status field.
func (o *SecuritySecurityGroup) SetStatus(v SecuritySecurityGroupStatus) {
	o.Status = &v
}

func (o SecuritySecurityGroup) MarshalJSON() ([]byte, error) {
...
type NullableSecuritySecurityGroup struct {
	value *SecuritySecurityGroup
	isSet bool
}

func (v NullableSecuritySecurityGroup) Get() *SecuritySecurityGroup {
	return v.value
}

func (v *NullableSecuritySecurityGroup) Set(val *SecuritySecurityGroup) {
	v.value = val
	v.isSet = true
}

func (v NullableSecuritySecurityGroup) IsSet() bool {
	return v.isSet
}

func (v *NullableSecuritySecurityGroup) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSecuritySecurityGroup(val *SecuritySecurityGroup) *NullableSecuritySecurityGroup {
	return &NullableSecuritySecurityGroup{value: val, isSet: true}
}

func (v NullableSecuritySecurityGroup) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSecuritySecurityGroup) UnmarshalJSON(src []byte) error {
	v.isSet = true
