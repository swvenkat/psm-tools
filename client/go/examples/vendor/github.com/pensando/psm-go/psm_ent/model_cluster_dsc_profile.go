...
// ClusterDSCProfile Profile.
type ClusterDSCProfile struct {
	ApiVersion *string `json:"api-version,omitempty"`
	Kind *string `json:"kind,omitempty"`
	Meta *ApiObjectMeta `json:"meta,omitempty"`
	Spec *ClusterDSCProfileSpec `json:"spec,omitempty"`
	Status *ClusterDSCProfileStatus `json:"status,omitempty"`
}
...
// SetSpec gets a reference to the given ClusterDSCProfileSpec and assigns it to the Spec field.
...
func (o *ClusterDSCProfile) GetStatus() ClusterDSCProfileStatus {
	if o == nil || o.Status == nil {
		var ret ClusterDSCProfileStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given ClusterDSCProfileStatus and assigns it to the Status field.
func (o *ClusterDSCProfile) SetStatus(v ClusterDSCProfileStatus) {
	o.Status = &v
}

func (o ClusterDSCProfile) MarshalJSON() ([]byte, error) {
...
type NullableClusterDSCProfile struct {
	value *ClusterDSCProfile
	isSet bool
}

func (v NullableClusterDSCProfile) Get() *ClusterDSCProfile {
	return v.value
}

func (v *NullableClusterDSCProfile) Set(val *ClusterDSCProfile) {
	v.value = val
	v.isSet = true
}

func (v NullableClusterDSCProfile) IsSet() bool {
	return v.isSet
}

func (v *NullableClusterDSCProfile) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClusterDSCProfile(val *ClusterDSCProfile) *NullableClusterDSCProfile {
	return &NullableClusterDSCProfile{value: val, isSet: true}
}

func (v NullableClusterDSCProfile) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClusterDSCProfile) UnmarshalJSON(src []byte) error {
	v.isSet = true
