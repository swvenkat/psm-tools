...
// ClusterDSCProfileList DSCProfileList is a container object for list of DSCProfile objects.
type ClusterDSCProfileList struct {
	ApiVersion *string `json:"api-version,omitempty"`
	// List of DSCProfile objects.
	Items *[]ClusterDSCProfile `json:"items,omitempty"`
...
// SetItems gets a reference to the given []ClusterDSCProfile and assigns it to the Items field.
...
func (o ClusterDSCProfileList) MarshalJSON() ([]byte, error) {
...
type NullableClusterDSCProfileList struct {
	value *ClusterDSCProfileList
	isSet bool
}

func (v NullableClusterDSCProfileList) Get() *ClusterDSCProfileList {
	return v.value
}

func (v *NullableClusterDSCProfileList) Set(val *ClusterDSCProfileList) {
	v.value = val
	v.isSet = true
}

func (v NullableClusterDSCProfileList) IsSet() bool {
	return v.isSet
}

func (v *NullableClusterDSCProfileList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClusterDSCProfileList(val *ClusterDSCProfileList) *NullableClusterDSCProfileList {
	return &NullableClusterDSCProfileList{value: val, isSet: true}
}

func (v NullableClusterDSCProfileList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClusterDSCProfileList) UnmarshalJSON(src []byte) error {
	v.isSet = true
