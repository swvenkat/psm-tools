...
// NetworkIPAMPolicy struct for NetworkIPAMPolicy
type NetworkIPAMPolicy struct {
	ApiVersion *string `json:"api-version,omitempty"`
	Kind *string `json:"kind,omitempty"`
	Meta *ApiObjectMeta `json:"meta,omitempty"`
	Spec *NetworkIPAMPolicySpec `json:"spec,omitempty"`
	Status *NetworkIPAMPolicyStatus `json:"status,omitempty"`
}
...
// SetSpec gets a reference to the given NetworkIPAMPolicySpec and assigns it to the Spec field.
...
func (o *NetworkIPAMPolicy) GetStatus() NetworkIPAMPolicyStatus {
	if o == nil || o.Status == nil {
		var ret NetworkIPAMPolicyStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given NetworkIPAMPolicyStatus and assigns it to the Status field.
func (o *NetworkIPAMPolicy) SetStatus(v NetworkIPAMPolicyStatus) {
	o.Status = &v
}

func (o NetworkIPAMPolicy) MarshalJSON() ([]byte, error) {
...
type NullableNetworkIPAMPolicy struct {
	value *NetworkIPAMPolicy
	isSet bool
}

func (v NullableNetworkIPAMPolicy) Get() *NetworkIPAMPolicy {
	return v.value
}

func (v *NullableNetworkIPAMPolicy) Set(val *NetworkIPAMPolicy) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkIPAMPolicy) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkIPAMPolicy) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkIPAMPolicy(val *NetworkIPAMPolicy) *NullableNetworkIPAMPolicy {
	return &NullableNetworkIPAMPolicy{value: val, isSet: true}
}

func (v NullableNetworkIPAMPolicy) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkIPAMPolicy) UnmarshalJSON(src []byte) error {
	v.isSet = true
