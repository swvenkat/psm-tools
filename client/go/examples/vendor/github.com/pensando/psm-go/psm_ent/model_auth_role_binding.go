...
// AuthRoleBinding RoleBinding is an assignment of a role to users or groups.
type AuthRoleBinding struct {
	ApiVersion *string `json:"api-version,omitempty"`
	Kind *string `json:"kind,omitempty"`
	Meta *ApiObjectMeta `json:"meta,omitempty"`
	Spec *AuthRoleBindingSpec `json:"spec,omitempty"`
...
// SetSpec gets a reference to the given AuthRoleBindingSpec and assigns it to the Spec field.
...
func (o AuthRoleBinding) MarshalJSON() ([]byte, error) {
...
type NullableAuthRoleBinding struct {
	value *AuthRoleBinding
	isSet bool
}

func (v NullableAuthRoleBinding) Get() *AuthRoleBinding {
	return v.value
}

func (v *NullableAuthRoleBinding) Set(val *AuthRoleBinding) {
	v.value = val
	v.isSet = true
}

func (v NullableAuthRoleBinding) IsSet() bool {
	return v.isSet
}

func (v *NullableAuthRoleBinding) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAuthRoleBinding(val *AuthRoleBinding) *NullableAuthRoleBinding {
	return &NullableAuthRoleBinding{value: val, isSet: true}
}

func (v NullableAuthRoleBinding) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAuthRoleBinding) UnmarshalJSON(src []byte) error {
	v.isSet = true
